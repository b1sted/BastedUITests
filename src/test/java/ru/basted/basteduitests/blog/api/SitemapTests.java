...
public class SitemapTests {
    private final String baseUrl = System.getProperty("baseUrl", "https://basted.ru");
    ...
    public void sitemapUrlsShouldReturn200() {
        HttpResponse<InputStream> response = apiHelper.getSitemapStream(baseUrl + "/sitemap.xml");
